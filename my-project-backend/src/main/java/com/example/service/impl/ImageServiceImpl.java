...
public class ImageServiceImpl extends ServiceImpl<ImageStoreMapper, StoreImage> implements ImageService {
    ...
    public String uploadAvatar(MultipartFile file, int id) throws IOException {
        ...
        try{
            ...
            log.error("Wrong while uploading avatar: " + e.getMessage(), e);
            return null;
        }
    }
    ...
    public String uploadImage(MultipartFile file, int id) throws IOException {
        ...
        try{
            client.putObject(args);
            if (this.save(new StoreImage(null, id, imageName, date))){return imageName;}
            else {return null;}
        }catch (Exception e){
            log.error("Wrong while uploading picture: " + e.getMessage(), e);
            return null;
        }
    }
